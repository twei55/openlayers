...
OpenLayers.Format.GeoRSS = OpenLayers.Class(OpenLayers.Format.XML, {
    ...
    createFeatureFromItem: function(item) {
        ...
        var title = this.getFirstChildValue(item, "*", "title", this.featureTitle);
       
        /* First try RSS descriptions, then Atom summaries */
        var description = this.getFirstChildValue(
            item, "*", "description",
            this.getFirstChildValue(item, "*", "content",
                this.getFirstChildValue(item, "*", "summary", this.featureDescription)));

        /* If no link URL is found in the first child node, try the
           href attribute */
        var link = this.getFirstChildValue(item, "*", "link");
        if(!link) {
            try {
        ...
        var id = this.getFirstChildValue(item, "*", "id", null);
